...
function Test() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const storeItemsData = await storeItemService.getStoreItem();
  ...
  async function editStoreItem(
    ...
    try {
      ...
      const storeItemData = await storeItemService.getStoreItem();
  ...
  return (
    <div>
      ...
      <section className="py-24 px-20">
        ...
        <CreateStoreItemForm onSave={addStoreItem} />
        <br />
        <DataTable
